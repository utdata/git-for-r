...
1.  `-b plot-experiment`: the `-b` flag tells Git that you'll be creating a new branch called `plot-experiment`. Without the flag, Git would try to switch to a branch that already existed.
