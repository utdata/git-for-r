...
1.  Now, in your terminal, type and run:

    ``` bash
    mkdir terminal_practice
    ```

1.  Now, run the `ls` command to make sure it worked. You should see your new directory listed in the terminal response.
...
1.  Now, make a new notes file inside the folder by running:

    ``` bash
    touch notes.txt
    ```

1.  Check that your new file is there by running `ls` command to list the files in your folder.
...
1.  Run the `ls` command to see the files inside your folder.
...
1.  Now, peek at your files and folders by running the `ls` inside your `terminal_practice` folder. Make sure the new folder is there.
1.  Next, we'll move the copy of your notes files *into* your new sub-folder by running:

    ``` bash
    mv copy_of_notes.txt my_new_folder/
    ```

1.  Now, run the `ls` command again to look at the files inside your `terminal_practice` folder. You should still see a new folder called `my_new_folder`, but you should *not* see the copy of your notes file.
...
1.  Now run `ls` to peek at the files. You should see your copy of the notes file listed.
...
1.  Run the `ls` to look at your files. You should see the copy of your notes files, but now with a new, cleaner name.
