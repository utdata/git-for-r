...
If you're still not sure, remember you can use your new friend the `pwd` command from chapter 1 by typing and running:
...
## Going Back Up (`cd ..`) [Editing stopped here]
...
If you get lost, just type the following to jump back to your home directory:
