...
1.  Type and run `pwd` to see where you are.
1.  Use `ls` to list what's inside.
1.  Pick a folder you see (try something other than your `Documents` folder).
1.  `cd` into that folder.
1.  Use `pwd` again to check that you moved.
1.  `cd ..` to come back up.
